      ...
      <Grid item xs={12} md={6} lg={6}>
        <Stack paddingLeft={{ xs: 0, lg: 5 }} alignItems={{ xs: 'center', lg: 'flex-end' }} paddingBottom={{ xs: 10 }}>
          ...
          <Typography textAlign={{ xs: 'center', md: 'end' }} fontSize={{ xs: '1rem', md: '1.1rem', lg: '1.2rem' }}>
            ללמוד לפתח זה דבר אחד - לממש את הלמידה זה משהו אחר לגמרי. כדי לפתח טוב, צריך להתאמץ ולא להפסיק לכתוב ולהכיר
            את הטכנולוגיות הכי חדישות ומתקדמות בשוק. זה מה שאנחנו שואפים אליו במועדון הפיתוח של המכללה למינהל. אנחנו
            לוקחים את הידע שלנו, ומנסים לדחוף אותו שלב אחד קדימה ולממש אותו.
          </Typography>
